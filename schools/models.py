...
class Classroom(models.Model):
    ...
    teacher = models.ForeignKey(
        "accounts.CustomUser", on_delete=models.CASCADE, related_name="courses"
    )
    students = models.ManyToManyField(
        "accounts.CustomUser", blank=True, related_name="enrolled_courses"
    )
...
class New(models.Model):
    ...
    classroom = models.ForeignKey(
        Classroom, on_delete=models.CASCADE, related_name="news"
    )
    ...
    viewed_by = models.ManyToManyField(
        "accounts.CustomUser", blank=True, related_name="viewed_news"
    )
...
class Exercise(models.Model):
    ...
    classroom = models.ForeignKey(
        Classroom, on_delete=models.CASCADE, related_name="exercises"
    )
    author = models.ForeignKey(
        "accounts.CustomUser",
        on_delete=models.CASCADE,
...
class Answer(models.Model):
    ...
    file = models.FileField(
        upload_to="answers/", validators=[validate_file_type], blank=True, null=True
    )
